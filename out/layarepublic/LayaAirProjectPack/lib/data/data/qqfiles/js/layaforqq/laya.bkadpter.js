...
(function(window,document,Laya){
	...
	var AtlasResourceManager=laya.webgl.atlas.AtlasResourceManager,Bitmap=laya.resource.Bitmap,Browser=laya.utils.Browser;
	var Canvas=BK.Canvas,Color$1=laya.utils.Color,Event=laya.events.Event,EventDispatcher=laya.events.EventDispatcher;
	var Font=laya.display.css.Font,HTMLCanvas=laya.resource.HTMLCanvas,HTMLImage=laya.resource.HTMLImage,Handler=laya.utils.Handler;
	var HitArea=laya.utils.HitArea,Input=laya.display.Input,Loader=laya.net.Loader,LocalStorage=laya.net.LocalStorage;
	var Matrix=laya.maths.Matrix,MouseManager=laya.events.MouseManager,Point=laya.maths.Point,Rectangle=laya.maths.Rectangle;
	var Render=laya.renders.Render,RenderContext=laya.renders.RenderContext,RenderSprite=laya.renders.RenderSprite;
	var RenderState2D=laya.webgl.utils.RenderState2D,RenderTarget2D=laya.webgl.resource.RenderTarget2D,RunDriver=laya.utils.RunDriver;
	...
	var URL=laya.net.URL,Utils=laya.utils.Utils,WebGL=laya.webgl.WebGL,WebGLCanvas=laya.webgl.resource.WebGLCanvas;
	var WebGLCharImage=laya.webgl.resource.WebGLCharImage,WebGLContext=laya.webgl.WebGLContext;
/**
*...
*@author ww
*/
...
var BKFileCache=(function(){
	...
	BKFileCache.getHttpFile=function(url,completeHandler,extension){
...
var StageAdpt=(function(){
	...
	*/
	...
	__static(StageAdpt,
	['_preTransformMatrix',function(){return this._preTransformMatrix=new Matrix();}
	]);
	return StageAdpt;
})()
